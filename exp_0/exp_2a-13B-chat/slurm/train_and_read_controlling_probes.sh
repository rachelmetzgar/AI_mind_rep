...
#SBATCH --gres=gpu:1
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_2a/logs/train_probes_%A.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_2a/logs/train_probes_%A.err
