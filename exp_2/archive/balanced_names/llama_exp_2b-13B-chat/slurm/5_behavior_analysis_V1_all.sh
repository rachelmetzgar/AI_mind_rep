#!/bin/bash
#SBATCH --job-name=behav_V1_bal
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=3:00:00
#SBATCH --array=0-11
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_names/llama_exp_2b-13B-chat/logs/behavior_v1/behavior_V1_all_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_names/llama_exp_2b-13B-chat/logs/behavior_v1/behavior_V1_all_%A_%a.err
# ---------------------------------------------------------------------------
# V1 Behavioral analysis: ALL strategies × ALL strengths (balanced_names)
# Array: 3 strategies × 4 strengths = 12 jobs (0-11)
# ---------------------------------------------------------------------------
