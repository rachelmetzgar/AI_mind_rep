...
#SBATCH --time=2:00:00
#SBATCH --array=0-1
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/llama_exp_2b-13B-chat/logs/behavior_v1/behavior_V1_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/llama_exp_2b-13B-chat/logs/behavior_v1/behavior_V1_%A_%a.err
# ---------------------------------------------------------------------------
