...
Reads per_conversation_probe_degradation.csv produced by 2d script.
Produces figures and statistical summaries.

Usage:
    python 2e_analyze_degradation_results.py
...
DATA_PATH = PROJECT / "results" / "degradation_analysis" / "per_conversation_probe_degradation.csv"
...
def main():
    if not DATA_PATH.exists():
        print(f"ERROR: {DATA_PATH} not found. Run 2d script first.")
        return
