...
Usage:
    python 2f_alternative_position_probes.py --condition control_first
    python 2f_alternative_position_probes.py --condition reading_irrelevant

Env: llama2_env (needs GPU)
Rachel C. Metzgar · Feb 2026
"""

import os, argparse, csv, json, glob, pickle
import numpy as np
import torch
...
if __name__ == "__main__":
    ...
    out_dir = f"data/probe_checkpoints/alternative/{args.condition}"
