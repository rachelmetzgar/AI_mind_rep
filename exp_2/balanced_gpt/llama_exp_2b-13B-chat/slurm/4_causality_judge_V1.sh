...
#SBATCH --mem=8G
#SBATCH --time=4:00:00
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_gpt/llama_exp_2b-13B-chat/logs/causality_judge_v1/judge_V1_%j.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_gpt/llama_exp_2b-13B-chat/logs/causality_judge_v1/judge_V1_%j.err
# ---------------------------------------------------------------------------
