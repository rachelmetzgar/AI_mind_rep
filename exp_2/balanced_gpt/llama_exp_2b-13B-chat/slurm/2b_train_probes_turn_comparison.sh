...
#SBATCH --gres=gpu:1
#SBATCH --array=0-3
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_gpt/llama_exp_2b-13B-chat/logs/probe_turn_cmp/turn_%a_%A.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_gpt/llama_exp_2b-13B-chat/logs/probe_turn_cmp/turn_%a_%A.err
