#!/usr/bin/env python3
"""
Generate comprehensive HTML summary of V1 behavioral analysis results for balanced_gpt/.
...
<head>
    ...
    <title>Exp 2 (balanced_gpt/) — V1 Behavioral Analysis Summary</title>
    <style>
...
<body>
    <h1>Experiment 2 (balanced_gpt/) — V1 Behavioral Analysis Summary</h1>

    <div class="summary-box">
        <p><strong>Generated:</strong> <span class="timestamp">{datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</span></p>
        <p><strong>Experiment variant:</strong> <code>exp_2/balanced_gpt/llama_exp_2b-13B-chat</code></p>
    ...
    <div class="warning-box">
        ...
        <code>balanced_balanced_gpt/</code> variant uses "Gregory/Rebecca" (human) and "ChatGPT/Copilot" (AI)
        to address this.</p>
    </div>
""")
...
""")
    ...
    <ol>
        ...
        <li><strong>Compare to balanced_balanced_gpt/:</strong> Check if gender-balanced names improve results.</li>
    </ol>
