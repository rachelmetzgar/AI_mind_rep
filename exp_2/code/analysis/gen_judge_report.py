...
# Project imports
EXP2_ROOT = Path(__file__).resolve().parent.parent.parent  # exp_2/
sys.path.insert(0, str(EXP2_ROOT / "code"))
...
def discover_judge_files(version):
    ...
    v1_dir = EXP2_ROOT / "data" / version / "intervention_results" / "V1"
...
def main():
    ...
    # Save report
    out_dir = EXP2_ROOT / "results" / "versions" / version / "V1_causality" / "judge"
