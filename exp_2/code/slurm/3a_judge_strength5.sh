...
#SBATCH --mem=8G
#SBATCH --time=4:00:00
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_2/logs/judge_V1_s5_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_2/logs/judge_V1_s5_%j.err
