...
#SBATCH --mem=64G
#SBATCH --time=4:00:00
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_2/logs/causality_V1_single_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_2/logs/causality_V1_single_%j.err
...
python code/pipeline/2_causality_generate.py --version "$VERSION" --mode V1 --strength $STRENGTH --layer_strategy peak_15
