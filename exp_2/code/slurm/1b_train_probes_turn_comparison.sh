...
#SBATCH --gres=gpu:1
#SBATCH --array=0-3
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/logs/probe_turn_cmp_%a_%A.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/logs/probe_turn_cmp_%a_%A.err
