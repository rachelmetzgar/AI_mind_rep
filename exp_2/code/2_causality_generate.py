...
from config import config as cfg, set_version, add_version_argument, add_model_argument, set_model, ensure_dir, ALL_STRATEGIES
...
def _init_paths():
    ...
    RESULT_DIR_V1 = str(cfg.PATHS.intervention_results_v1)
    RESULT_DIR_V2 = str(cfg.PATHS.intervention_results_v2)
