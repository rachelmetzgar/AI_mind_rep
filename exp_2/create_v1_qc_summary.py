...
EXP2_ROOT = Path(__file__).parent

VARIANTS = {
    "names": {
        "label": "Names (Sam/Casey)",
        "color": "#e74c3c",
        "path": EXP2_ROOT / "names" / "llama_exp_2b-13B-chat",
    ...
    "balanced_names": {
        ...
        "color": "#3498db",
        "path": EXP2_ROOT / "balanced_names" / "llama_exp_2b-13B-chat",
    ...
    "balanced_gpt": {
        ...
        "color": "#2ecc71",
        "path": EXP2_ROOT / "balanced_gpt" / "llama_exp_2b-13B-chat",
        "strategies": ["peak_15", "wide", "all_70"],
    ...
    "labels": {
        ...
        "color": "#9b59b6",
        "path": EXP2_ROOT / "labels" / "llama_exp_2b-13B-chat",
        "strategies": ["peak_15", "wide", "all_70"],
        "strengths": [2, 4, 5, 6],
        "reading_probe": "reading_probes_peak",
...
def load_all_stats():
    ...
    for vname, vconf in VARIANTS.items():
        v1_dir = vconf["path"] / "data" / "intervention_results" / "V1"
...
def load_sample_generations(variant_name, strategy, strength, probe_type="control_probes", n_samples=1):
    ...
    csv_path = (vconf["path"] / "data" / "intervention_results" / "V1" /
...
def main():
    ...
    output_path = EXP2_ROOT / "v1_qc_summary_all_variants.html"
    ...
    for vname, vconf in VARIANTS.items():
        results_dir = vconf["path"] / "results"
