...
#SBATCH --array=0-99
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/labels/llama_exp_2b-13B-chat/logs/causality_v2/causality_V2_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/labels/llama_exp_2b-13B-chat/logs/causality_v2/causality_V2_%A_%a.err
# ---------------------------------------------------------------------------
