...
#SBATCH --array=0-99
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_names/llama_exp_2b-13B-chat/logs/causality_v2/causality_V2_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2/balanced_names/llama_exp_2b-13B-chat/logs/causality_v2/causality_V2_%A_%a.err
# ---------------------------------------------------------------------------
...
python "$PY_SCRIPT" --version V2 --subject_idx $SUBJECT_IDX --strength $N --layer_strategy peak_15 wide all_70
