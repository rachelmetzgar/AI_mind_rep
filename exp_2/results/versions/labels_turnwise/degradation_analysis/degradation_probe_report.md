...
This report analyzes two related questions about the labels_turnwise version of Experiment 1:
...
| Reading | 2 | 0.999 | 1.000 | 0.997 |
| Reading | 3 | 1.000 | 0.999 | 1.000 |
| Reading | 4 | 0.960 | 0.970 | 0.949 |
| Reading | 5 | 0.931 | 0.933 | 0.930 |
| Control | 1 | 1.000 | 1.000 | 1.000 |
| Control | 2 | 0.999 | 1.000 | 0.998 |
| Control | 3 | 0.995 | 0.994 | 0.996 |
| Control | 4 | 0.978 | 0.981 | 0.974 |
| Control | 5 | 0.890 | 0.875 | 0.905 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Type-Token Ratio (TTR) | 1 | 0.7265 | 0.7272 | -0.0008 | -0.21 | 0.8348 |  |
| Type-Token Ratio (TTR) | 5 | 0.5671 | 0.5811 | -0.0140 | -3.27 | 0.0011 | ** |
| Trigram Repetition Rate | 1 | 0.0091 | 0.0087 | +0.0004 | 0.66 | 0.5075 |  |
| Trigram Repetition Rate | 5 | 0.0727 | 0.0646 | +0.0081 | 2.28 | 0.0227 | * |
| Word Count | 1 | 123.6060 | 122.5680 | +1.0380 | 0.47 | 0.6380 |  |
| Word Count | 5 | 222.7400 | 210.9370 | +11.8030 | 3.57 | 0.0004 | *** |
| Self-Reference Rate | 1 | 0.0455 | 0.0419 | +0.0036 | 3.15 | 0.0017 | ** |
| Self-Reference Rate | 5 | 0.0357 | 0.0351 | +0.0006 | 0.59 | 0.5567 |  |
| ALL-CAPS Ratio | 1 | 0.0009 | 0.0024 | -0.0015 | -6.71 | 0.0000 | *** |
| ALL-CAPS Ratio | 5 | 0.0828 | 0.0772 | +0.0055 | 0.54 | 0.5875 |  |
| Exclamation Rate | 1 | 0.0190 | 0.0175 | +0.0015 | 2.40 | 0.0164 | * |
| Exclamation Rate | 5 | 0.0220 | 0.0229 | -0.0009 | -0.99 | 0.3236 |  |
| Emoji Count | 1 | 0.2550 | 0.1710 | +0.0840 | 3.10 | 0.0020 | ** |
| Emoji Count | 5 | 1.6900 | 1.8790 | -0.1890 | -1.19 | 0.2337 |  |
...
| --- | --- | --- | --- | --- | --- | --- |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | all | 0.072 | 0.0012 | ** | 2000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | human | -0.039 | 0.2229 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | ai | 0.115 | 0.0003 | *** | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | all | 0.082 | 0.0002 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | human | -0.027 | 0.3874 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | ai | 0.143 | 0.0000 | *** | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | all | 0.072 | 0.0012 | ** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | human | -0.014 | 0.6470 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | ai | 0.139 | 0.0000 | *** | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | all | 0.070 | 0.0017 | ** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | human | -0.022 | 0.4967 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | ai | 0.137 | 0.0000 | *** | 1000 |
