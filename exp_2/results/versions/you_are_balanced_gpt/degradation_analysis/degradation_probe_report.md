# Degradation & Probe Confidence Analysis: you_are_balanced_gpt


Generated: 2026-03-02 10:37 —
Version: `you_are_balanced_gpt` —
50 subjects x 40 conversations = 2000 conversations x 5 turns = 10000 observations


### Approach: you_are_balanced_gpt
...
This report analyzes two related questions about the you_are_balanced_gpt version of Experiment 1:
...
| Reading | 2 | 0.999 | 0.998 | 0.999 |
| Reading | 3 | 0.998 | 0.997 | 0.998 |
| Reading | 4 | 0.970 | 0.962 | 0.977 |
| Reading | 5 | 0.960 | 0.957 | 0.963 |
| Control | 1 | 0.993 | 1.000 | 0.985 |
| Control | 2 | 1.000 | 1.000 | 1.000 |
| Control | 3 | 1.000 | 1.000 | 1.000 |
| Control | 4 | 0.988 | 0.976 | 0.999 |
| Control | 5 | 0.949 | 0.934 | 0.964 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Type-Token Ratio (TTR) | 1 | 0.7417 | 0.7481 | -0.0064 | -1.67 | 0.0957 |  |
| Type-Token Ratio (TTR) | 5 | 0.5889 | 0.6167 | -0.0278 | -6.38 | 0.0000 | *** |
| Trigram Repetition Rate | 1 | 0.0072 | 0.0093 | -0.0021 | -3.31 | 0.0009 | *** |
| Trigram Repetition Rate | 5 | 0.0609 | 0.0490 | +0.0119 | 3.97 | 0.0001 | *** |
| Word Count | 1 | 112.0910 | 110.0080 | +2.0830 | 0.99 | 0.3218 |  |
| Word Count | 5 | 204.5640 | 186.8520 | +17.7120 | 5.22 | 0.0000 | *** |
| Self-Reference Rate | 1 | 0.0412 | 0.0413 | -0.0001 | -0.13 | 0.8993 |  |
| Self-Reference Rate | 5 | 0.0352 | 0.0357 | -0.0005 | -0.49 | 0.6255 |  |
| ALL-CAPS Ratio | 1 | 0.0006 | 0.0061 | -0.0055 | -20.95 | 0.0000 | *** |
| ALL-CAPS Ratio | 5 | 0.0548 | 0.0524 | +0.0024 | 0.29 | 0.7756 |  |
| Exclamation Rate | 1 | 0.0107 | 0.0167 | -0.0060 | -11.39 | 0.0000 | *** |
| Exclamation Rate | 5 | 0.0211 | 0.0205 | +0.0006 | 0.77 | 0.4441 |  |
| Emoji Count | 1 | 0.0830 | 0.1590 | -0.0760 | -3.26 | 0.0011 | ** |
| Emoji Count | 5 | 1.2430 | 1.6490 | -0.4060 | -2.97 | 0.0030 | ** |
...
| --- | --- | --- | --- | --- | --- | --- |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | all | 0.101 | 0.0000 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | human | -0.036 | 0.2558 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | ai | 0.094 | 0.0030 | ** | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | all | 0.117 | 0.0000 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | human | -0.007 | 0.8328 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | ai | 0.155 | 0.0000 | *** | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | all | 0.109 | 0.0000 | *** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | human | -0.033 | 0.2980 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | ai | 0.124 | 0.0001 | *** | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | all | 0.119 | 0.0000 | *** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | human | -0.036 | 0.2617 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | ai | 0.200 | 0.0000 | *** | 1000 |
