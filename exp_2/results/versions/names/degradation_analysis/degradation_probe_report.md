# Degradation & Probe Confidence Analysis: Names
...
Partner labeled with specific names (Sam/Casey for human, ChatGPT/Copilot for AI). Gender-confounded.
...
This report analyzes two related questions about the Names version of Experiment 1:
...
| Reading | 3 | 0.999 | 0.999 | 0.999 |
| Reading | 4 | 0.994 | 0.995 | 0.992 |
| Reading | 5 | 0.955 | 0.958 | 0.952 |
| Control | 1 | 0.993 | 1.000 | 0.985 |
| Control | 2 | 0.998 | 0.998 | 0.998 |
| Control | 3 | 0.999 | 0.998 | 0.999 |
| Control | 4 | 0.990 | 0.992 | 0.988 |
| Control | 5 | 0.956 | 0.953 | 0.958 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Type-Token Ratio (TTR) | 1 | 0.7486 | 0.7436 | +0.0051 | 1.40 | 0.1606 |  |
| Type-Token Ratio (TTR) | 5 | 0.5901 | 0.6094 | -0.0193 | -4.45 | 0.0000 | *** |
| Trigram Repetition Rate | 1 | 0.0069 | 0.0073 | -0.0005 | -0.89 | 0.3735 |  |
| Trigram Repetition Rate | 5 | 0.0631 | 0.0545 | +0.0086 | 2.77 | 0.0056 | ** |
| Word Count | 1 | 110.7430 | 115.6260 | -4.8830 | -2.38 | 0.0175 | * |
| Word Count | 5 | 203.6800 | 193.9840 | +9.6960 | 2.98 | 0.0029 | ** |
| Self-Reference Rate | 1 | 0.0432 | 0.0406 | +0.0026 | 2.28 | 0.0225 | * |
| Self-Reference Rate | 5 | 0.0341 | 0.0356 | -0.0016 | -1.67 | 0.0947 |  |
| ALL-CAPS Ratio | 1 | 0.0014 | 0.0012 | +0.0002 | 1.02 | 0.3078 |  |
| ALL-CAPS Ratio | 5 | 0.0807 | 0.0662 | +0.0145 | 1.48 | 0.1393 |  |
| Exclamation Rate | 1 | 0.0176 | 0.0172 | +0.0005 | 0.73 | 0.4667 |  |
| Exclamation Rate | 5 | 0.0261 | 0.0234 | +0.0027 | 2.88 | 0.0040 | ** |
| Emoji Count | 1 | 0.3460 | 0.2970 | +0.0490 | 1.34 | 0.1803 |  |
| Emoji Count | 5 | 2.0970 | 2.1620 | -0.0650 | -0.38 | 0.7009 |  |
...
| --- | --- | --- | --- | --- | --- | --- |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | all | 0.110 | 0.0000 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | human | 0.027 | 0.3902 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | ai | 0.094 | 0.0030 | ** | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | all | 0.113 | 0.0000 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | human | 0.039 | 0.2198 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | ai | 0.096 | 0.0023 | ** | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | all | 0.074 | 0.0009 | *** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | human | -0.004 | 0.9070 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | ai | 0.081 | 0.0100 | * | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | all | 0.077 | 0.0006 | *** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | human | 0.007 | 0.8232 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | ai | 0.088 | 0.0052 | ** | 1000 |
