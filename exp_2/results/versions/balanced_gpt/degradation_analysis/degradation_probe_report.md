# Degradation & Probe Confidence Analysis: Balanced GPT
...
### Approach: Balanced GPT


Partner labeled with gender-balanced names (Gregory/Rebecca for human, ChatGPT/GPT-4 for AI).
...
This report analyzes two related questions about the Balanced GPT version of Experiment 1:
...
| Reading | 2 | 0.998 | 0.996 | 0.999 |
| Reading | 3 | 0.999 | 1.000 | 0.998 |
| Reading | 4 | 0.986 | 0.983 | 0.989 |
| Reading | 5 | 0.956 | 0.957 | 0.954 |
| Control | 1 | 1.000 | 1.000 | 1.000 |
| Control | 2 | 0.999 | 0.998 | 1.000 |
| Control | 3 | 1.000 | 0.999 | 1.000 |
| Control | 4 | 0.973 | 0.953 | 0.992 |
| Control | 5 | 0.959 | 0.961 | 0.956 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Type-Token Ratio (TTR) | 1 | 0.7470 | 0.7378 | +0.0093 | 2.54 | 0.0111 | * |
| Type-Token Ratio (TTR) | 5 | 0.5883 | 0.6008 | -0.0125 | -2.83 | 0.0047 | ** |
| Trigram Repetition Rate | 1 | 0.0068 | 0.0083 | -0.0015 | -2.57 | 0.0102 | * |
| Trigram Repetition Rate | 5 | 0.0621 | 0.0551 | +0.0069 | 2.18 | 0.0295 | * |
| Word Count | 1 | 110.7090 | 115.7940 | -5.0850 | -2.51 | 0.0121 | * |
| Word Count | 5 | 205.3730 | 197.2730 | +8.1000 | 2.46 | 0.0140 | * |
| Self-Reference Rate | 1 | 0.0441 | 0.0412 | +0.0028 | 2.52 | 0.0119 | * |
| Self-Reference Rate | 5 | 0.0365 | 0.0358 | +0.0006 | 0.66 | 0.5114 |  |
| ALL-CAPS Ratio | 1 | 0.0009 | 0.0034 | -0.0024 | -10.23 | 0.0000 | *** |
| ALL-CAPS Ratio | 5 | 0.0661 | 0.0690 | -0.0030 | -0.32 | 0.7516 |  |
| Exclamation Rate | 1 | 0.0162 | 0.0176 | -0.0014 | -2.24 | 0.0252 | * |
| Exclamation Rate | 5 | 0.0245 | 0.0226 | +0.0019 | 2.03 | 0.0423 | * |
| Emoji Count | 1 | 0.2870 | 0.2930 | -0.0060 | -0.18 | 0.8565 |  |
| Emoji Count | 5 | 1.5350 | 2.1490 | -0.6140 | -3.98 | 0.0001 | *** |
...
| --- | --- | --- | --- | --- | --- | --- |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | all | 0.095 | 0.0000 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | human | 0.007 | 0.8330 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | ai | 0.087 | 0.0060 | ** | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | all | 0.095 | 0.0000 | *** | 2000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | human | 0.011 | 0.7181 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | ai | 0.081 | 0.0108 | * | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | all | 0.065 | 0.0036 | ** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | human | -0.010 | 0.7585 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | ai | 0.077 | 0.0145 | * | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | all | 0.066 | 0.0032 | ** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | human | -0.004 | 0.8914 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | ai | 0.073 | 0.0215 | * | 1000 |
