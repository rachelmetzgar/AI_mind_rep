# Degradation & Probe Confidence Analysis: Nonsense Codeword


Generated: 2026-02-27 13:29 —
Version: `nonsense_codeword` —
50 subjects x 40 conversations = 2000 conversations x 5 turns = 10000 observations


### Approach: Nonsense Codeword


Token-matched control: the identity tokens ("a Human"/"an AI") appear in a semantically inert context ("code word"). Tests whether behavioral effects require semantic processing of the identity instruction.


**System prompt (key sentence):** `"Your assigned session code word is {a Human / an AI}."`
...
This report analyzes two related questions about the Nonsense Codeword version of Experiment 1:
...
| Reading | 2 | 0.999 | 0.999 | 0.999 |
| Reading | 3 | 0.999 | 1.000 | 0.997 |
| Reading | 4 | 0.942 | 0.931 | 0.952 |
| Reading | 5 | 0.564 | 0.756 | 0.372 |
| Control | 1 | 1.000 | 1.000 | 1.000 |
| Control | 2 | 0.998 | 0.998 | 0.997 |
| Control | 3 | 0.968 | 0.968 | 0.967 |
| Control | 4 | 0.812 | 0.786 | 0.839 |
| Control | 5 | 0.592 | 0.483 | 0.701 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Type-Token Ratio (TTR) | 1 | 0.6979 | 0.7178 | -0.0199 | -5.15 | 0.0000 | *** |
| Type-Token Ratio (TTR) | 5 | 0.5800 | 0.5800 | +0.0001 | 0.02 | 0.9831 |  |
| Trigram Repetition Rate | 1 | 0.0121 | 0.0098 | +0.0023 | 3.38 | 0.0007 | *** |
| Trigram Repetition Rate | 5 | 0.0640 | 0.0642 | -0.0002 | -0.06 | 0.9493 |  |
| Word Count | 1 | 142.6290 | 132.5340 | +10.0950 | 4.27 | 0.0000 | *** |
| Word Count | 5 | 210.0880 | 211.0210 | -0.9330 | -0.28 | 0.7787 |  |
| Self-Reference Rate | 1 | 0.0495 | 0.0476 | +0.0019 | 1.65 | 0.0982 |  |
| Self-Reference Rate | 5 | 0.0343 | 0.0367 | -0.0024 | -2.48 | 0.0131 | * |
| ALL-CAPS Ratio | 1 | 0.0010 | 0.0013 | -0.0003 | -1.44 | 0.1496 |  |
| ALL-CAPS Ratio | 5 | 0.0485 | 0.0482 | +0.0003 | 0.04 | 0.9687 |  |
| Exclamation Rate | 1 | 0.0160 | 0.0186 | -0.0027 | -4.22 | 0.0000 | *** |
| Exclamation Rate | 5 | 0.0670 | 0.0203 | +0.0467 | 0.96 | 0.3384 |  |
| Emoji Count | 1 | 0.1100 | 0.1560 | -0.0460 | -2.38 | 0.0175 | * |
| Emoji Count | 5 | 1.1040 | 1.3980 | -0.2940 | -2.16 | 0.0306 | * |
...
| --- | --- | --- | --- | --- | --- | --- |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | all | -0.060 | 0.0074 | ** | 2000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | human | -0.041 | 0.1989 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Reading Probe Confidence | ai | -0.058 | 0.0662 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | all | -0.023 | 0.2998 |  | 2000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | human | -0.030 | 0.3413 |  | 1000 |
| TTR Drop (Turn 1 to 5) | Control Probe Confidence | ai | 0.015 | 0.6425 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | all | -0.064 | 0.0043 | ** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | human | -0.028 | 0.3742 |  | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Reading Probe Confidence | ai | -0.092 | 0.0036 | ** | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | all | -0.071 | 0.0014 | ** | 2000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | human | -0.073 | 0.0214 | * | 1000 |
| Trigram Rep. Increase (Turn 1 to 5) | Control Probe Confidence | ai | -0.067 | 0.0355 | * | 1000 |
