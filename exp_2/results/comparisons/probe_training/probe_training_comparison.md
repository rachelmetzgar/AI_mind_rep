...
> All figures use a unified y-axis scale [0.40, 0.87] for direct visual comparison across versions.
...
| **Labels Turnwise** | 67.8% (L38) | 67.5% (L40) | 62.0% | 62.2% | -0.2% | t(40)=-0.61 | p=0.545 | d=-0.10 |
| **You Are Labels** | 60.5% (L38) | 60.2% (L34) | 55.8% | 56.3% | -0.5% | t(40)=-1.27 | p=0.210 | d=-0.20 |
| **You Are Labels Turnwise** | 68.5% (L14) | 70.5% (L18) | 64.0% | 65.7% | -1.7% | t(40)=-4.32 | p=0.000 | d=-0.67 |
| **You Are Balanced GPT** | 82.0% (L27) | 81.0% (L16) | 73.8% | 74.7% | -0.9% | t(40)=-3.47 | p=0.001 | d=-0.54 |
...
Same as Labels but partner messages prefixed "Human:" / "AI:" instead of "Partner:". Tests turn-level identity reinforcement.

![Labels Turnwise — Accuracy by Layer Group](figures/acc_by_layer_group_labels_turnwise.png)

### 6. You Are Labels

"You are talking to {type}." Uses direct framing instead of "you believe you are speaking with."

![You Are Labels — Accuracy by Layer Group](figures/acc_by_layer_group_you_are_labels.png)

### 7. You Are Labels Turnwise

"You are talking to {type}" + "Human:"/"AI:" turn prefix. Combines direct framing with turn-level reinforcement.

![You Are Labels Turnwise — Accuracy by Layer Group](figures/acc_by_layer_group_you_are_labels_turnwise.png)

### 8. You Are Balanced GPT

"You are talking to {name} ({type})." Direct framing with gender-balanced names + GPT-4.

![You Are Balanced GPT — Accuracy by Layer Group](figures/acc_by_layer_group_you_are_balanced_gpt.png)
...
![Labels Turnwise — Best Test Acc by Layer](figures/best_test_acc_by_layer_labels_turnwise.png)

### 6. You Are Labels

"You are talking to {type}." Uses direct framing instead of "you believe you are speaking with."

![You Are Labels — Best Test Acc by Layer](figures/best_test_acc_by_layer_you_are_labels.png)

### 7. You Are Labels Turnwise

"You are talking to {type}" + "Human:"/"AI:" turn prefix. Combines direct framing with turn-level reinforcement.

![You Are Labels Turnwise — Best Test Acc by Layer](figures/best_test_acc_by_layer_you_are_labels_turnwise.png)

### 8. You Are Balanced GPT

"You are talking to {name} ({type})." Direct framing with gender-balanced names + GPT-4.

![You Are Balanced GPT — Best Test Acc by Layer](figures/best_test_acc_by_layer_you_are_balanced_gpt.png)
