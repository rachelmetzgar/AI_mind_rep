...
Directory structure expected:
    intervention_results/V{1,2}/{layer_strategy}/{probe_type}/is_{N}/...

Usage:
    # Judge a specific strategy + strength:
    python 3b_causality_judge.py --version V1 --layer_strategy narrow --result_dir data/intervention_results/V1/narrow/control_probes/is_8

    # Judge all probe types × strengths for one strategy:
    python 3b_causality_judge.py --version V1 --layer_strategy narrow

    # Judge multiple strategies:
    python 3b_causality_judge.py --version V1 --layer_strategy narrow wide peak_15

    # Judge V2, single subject:
    python 3b_causality_judge.py --version V2 --layer_strategy narrow --subject s001

    # Judge V2, all subjects for a strategy:
    python 3b_causality_judge.py --version V2 --layer_strategy narrow
...
ALL_STRATEGIES = ["narrow", "wide", "peak_15", "all_70"]
...
Examples:
  ...
  # Judge narrow + wide:
  python 3b_causality_judge.py --version V1 --layer_strategy narrow wide

  # Judge a specific directory directly:
  python 3b_causality_judge.py --version V1 --layer_strategy narrow \\
      --result_dir data/intervention_results/V1/narrow/control_probes/is_8

  # Judge V2, one subject across strategies:
  python 3b_causality_judge.py --version V2 --layer_strategy narrow wide --subject s001

  # Force re-judge (overwrite existing judge_results.json):
  python 3b_causality_judge.py --version V1 --layer_strategy narrow --force
        """,
    )
    ...
    p.add_argument(
        ...
        help="Root directory for results (default: data/intervention_results/V{1,2}).",
    )
    p.add_argument(
...
def main():
    ...
    print_summary(all_results, args.version)
