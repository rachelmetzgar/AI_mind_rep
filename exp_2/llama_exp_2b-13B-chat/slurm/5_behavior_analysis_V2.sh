...
#SBATCH --time=4:00:00
#SBATCH --array=0
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_2b/llama_exp_2b-13B-chat/logs/behavior_v2/behavior_V2_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_2b/llama_exp_2b-13B-chat/logs/behavior_v2/behavior_V2_%A_%a.err
...
python 5_behavior_analysis.py --version v2 --strength $N $TOPICS_FLAG
