...
echo ""
echo "Data Files:"
DATA_DIR="/jukebox/graziano/rachel/ai_mind_rep/exp_1/labels_turnwise/data/meta-llama-Llama-2-13b-chat-hf/0.8"
if [ -d "$DATA_DIR" ]; then
...
echo ""
echo "Results:"
RESULTS_DIR="/jukebox/graziano/rachel/ai_mind_rep/exp_1/labels_turnwise/results/meta-llama-Llama-2-13b-chat-hf/0.8"
...
LOG_DIR="/jukebox/graziano/rachel/ai_mind_rep/exp_1/labels_turnwise/logs"
if [ -d "$LOG_DIR" ]; then
