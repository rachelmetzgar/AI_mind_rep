...
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_balanced_gpt/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_balanced_gpt/logs/identity_breakdown_%j.err
