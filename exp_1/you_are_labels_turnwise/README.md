# Experiment 1 (You Are Labels Turnwise) — "You Are Talking To" Framing + Turn-Level Identity Prefix

**Author:** Rachel C. Metzgar, Princeton University
**Repo root:** `ai_mind_rep/exp_1/you_are_labels_turnwise`
**Python:** 3.11+

## What Changed from `labels/` and `labels_turnwise/`

This version builds on `labels_turnwise/` with a different framing:
- Uses "you are talking to a Human/an AI" instead of "you believe you are speaking with a Human/an AI"
- Like `labels_turnwise/`: each partner turn is prefixed with the identity label ("Human:" or "AI:") instead of the generic "Partner:"

| | `labels/` | `labels_turnwise/` | `you_are_labels_turnwise/` (this version) |
|---|---|---|---|
| System prompt | "...you believe you are speaking with a Human/an AI" | "...you believe you are speaking with a Human/an AI" | "...you are talking to a Human/an AI" |
| Turn prefix | "Partner:" | "Human:" / "AI:" | "Human:" / "AI:" |
| Identity reinforcement | System prompt only | Every turn (via label) | Every turn (via label) |

### Why the change

The `labels_turnwise/` version uses "you believe you are speaking with" framing. `you_are_labels_turnwise` tests whether the more direct "you are talking to" framing produces different behavioral effects.
