...
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_labels_turnwise/logs/analysis_pipeline_%j.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_labels_turnwise/logs/analysis_pipeline_%j.err
