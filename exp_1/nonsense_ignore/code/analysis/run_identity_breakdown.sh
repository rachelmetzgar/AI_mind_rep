...
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_1/nonsense_ignore/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_1/nonsense_ignore/logs/identity_breakdown_%j.err
...
# === Project paths ===
export PROJECT_ROOT="/jukebox/graziano/rachel/ai_mind_rep/exp_1/nonsense_ignore"
