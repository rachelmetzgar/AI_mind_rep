...
Purpose:
    ...
    (Gregory, Rebecca, ChatGPT, GPT-4) in the balanced_gpt exp_1 dataset.
...
Run from:
    exp_1/balanced_gpt/code/analysis/

Author: Rachel C. Metzgar
Date: 2026-02-19
Modified: 2026-02-19 - balanced_gpt version (Copilot → GPT-4)
"""
...
<head>
<meta charset="UTF-8">
<title>Identity Breakdown — Exp 1 (balanced_gpt)</title>
<style>
...
<body>
<h1>Identity Breakdown: Gregory · Rebecca · ChatGPT · GPT-4
    &nbsp;<small style="font-weight:normal;font-size:0.7em">
    Exp 1 — balanced_gpt — LLaMA-2-13B-Chat &nbsp;|&nbsp; Generated: {generated}
    </small>
</h1>
{methods_html}
{anova_html}
...
def main():
    ...
    print("=" * 65)
    print("IDENTITY BREAKDOWN ANALYSIS — balanced_gpt")
