...
echo ""
echo "Results:"
RESULTS_DIR="/jukebox/graziano/rachel/ai_mind_rep/exp_1/balanced_gpt/results/meta-llama-Llama-2-13b-chat-hf/0.8"
...
LOG_DIR="/jukebox/graziano/rachel/ai_mind_rep/exp_1/balanced_gpt/logs"
if [ -d "$LOG_DIR" ]; then
