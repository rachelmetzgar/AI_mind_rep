#!/bin/bash
#SBATCH --job-name=nonsense_ignore_data_gen
#SBATCH --partition=all
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --time=08:00:00
#SBATCH --array=0-49
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/nonsense_ignore/logs/llm_data_gen_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/nonsense_ignore/logs/llm_data_gen_%A_%a.err

# SLURM ARRAY SCRIPT — Exp 1 (nonsense_ignore control)
...
# === Project paths ===
PROJECT_ROOT="/jukebox/graziano/rachel/mind_rep/exp_1/versions/nonsense_ignore"
