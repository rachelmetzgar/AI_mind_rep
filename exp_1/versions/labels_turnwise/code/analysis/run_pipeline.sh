#!/bin/bash
#SBATCH --job-name=labels_tw_analysis
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=2:00:00
#SBATCH --cpus-per-task=2
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/labels_turnwise/logs/analysis_pipeline_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/labels_turnwise/logs/analysis_pipeline_%j.err

# ---------------------------------------------------------------------------
# Automated analysis pipeline for labels_turnwise experiment.
...
echo "=================================================================="
echo "LABELS_TURNWISE ANALYSIS PIPELINE"
echo "Started: $(date)"
echo "Host: $HOSTNAME"
