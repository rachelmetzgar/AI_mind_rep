...
Purpose:
    Type-level behavioral analysis (Human vs AI) in the labels_turnwise exp_1 dataset.

    Like labels/, this version has only two partner conditions ("a Human" / "an AI")
    with no individual identity variation, but reinforces identity at every turn
    via "Human:"/"AI:" prefixes. Paired t-tests per metric with BH-FDR correction.
...
Run from:
    exp_1/labels_turnwise/code/analysis/
...
# ── Agent mapping ─────────────────────────────────────────────────────────────
# labels_turnwise/ uses type labels with turn-level identity prefixes.
...
def build_html(
    ...
    <div class="card">
      ...
      <ul>
        ...
        <li><b>Note:</b> This is the <code>labels_turnwise/</code> version with generic
            type labels ("a Human" / "an AI") and turn-level "Human:"/"AI:" prefixes.</li>
      </ul>
    </div>
    """)
    ...
    <div class="card">
      ...
      <h3>Notes</h3>
      <ul>
        <li>This is the <b>labels_turnwise</b> version: partners are identified as
            "a Human" or "an AI" (no individual names), and each partner turn is
            prefixed with "Human:" or "AI:" to reinforce identity at every turn.</li>
...
<head>
<meta charset="UTF-8">
<title>Type-Level Behavioral Analysis -- Exp 1 (labels_turnwise)</title>
<style>
...
<h1>Human vs AI: Type-Level Behavioral Analysis
    ...
    Exp 1 -- labels_turnwise -- LLaMA-2-13B-Chat &nbsp;|&nbsp; Generated: {generated}
    </small>
</h1>
{methods_html}
{summary_html}
...
def main():
    ...
    print("=" * 65)
    print("TYPE-LEVEL BEHAVIORAL ANALYSIS -- labels_turnwise")
    ...
    with open(txt_path, "w") as f:
        f.write(f"TYPE-LEVEL BEHAVIORAL ANALYSIS STATS (labels_turnwise)\n")
