...
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_names/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_names/logs/identity_breakdown_%j.err
...
# === Project paths ===
PROJECT_ROOT="/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_names"
