...
**Repo root:** `mind_rep/exp_1/balanced_names`
**Python:** 3.11+
...
cd /jukebox/graziano/rachel/mind_rep/exp_1/balanced_names
export PROJECT_ROOT=/jukebox/graziano/rachel/mind_rep/exp_1/balanced_names/
