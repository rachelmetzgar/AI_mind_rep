#!/bin/bash
# Quick status checker for you_are_labels_turnwise experiment
# Usage: bash check_status.sh

echo "=================================================================="
echo "YOU_ARE_LABELS_TURNWISE STATUS CHECK"
echo "$(date)"
echo "=================================================================="
...
echo ""
echo "Data Files:"
DATA_DIR="/jukebox/graziano/rachel/mind_rep/exp_1/versions/you_are_labels_turnwise/data/meta-llama-Llama-2-13b-chat-hf/0.8"
if [ -d "$DATA_DIR" ]; then
...
echo ""
echo "Results:"
RESULTS_DIR="/jukebox/graziano/rachel/mind_rep/exp_1/versions/you_are_labels_turnwise/results/meta-llama-Llama-2-13b-chat-hf/0.8"
...
LOG_DIR="/jukebox/graziano/rachel/mind_rep/exp_1/versions/you_are_labels_turnwise/logs"
if [ -d "$LOG_DIR" ]; then
