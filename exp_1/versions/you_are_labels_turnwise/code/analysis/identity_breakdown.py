...
Purpose:
    Type-level behavioral analysis (Human vs AI) in the you_are_labels_turnwise exp_1 dataset.

    Like labels/, this version has only two partner conditions ("a Human" / "an AI")
    with no individual identity variation, but uses "you are talking to" framing and
    reinforces identity at every turn via "Human:"/"AI:" prefixes.
    Paired t-tests per metric with BH-FDR correction.
...
Run from:
    exp_1/you_are_labels_turnwise/code/analysis/

Author: Rachel C. Metzgar
Date: 2026-02-20
Modified: 2026-02-20 - Renamed output files to per_trial_results.*
"""
...
# ── Agent mapping ─────────────────────────────────────────────────────────────
# you_are_labels_turnwise/ uses type labels with "you are talking to" framing + turn-level identity prefixes.
...
def build_html(
    ...
    <div class="card">
      ...
      <ul>
        ...
        <li><b>Note:</b> This is the <code>you_are_labels_turnwise/</code> version with generic
            type labels ("a Human" / "an AI"), "you are talking to" framing, and turn-level "Human:"/"AI:" prefixes.</li>
      </ul>
    </div>
    """)
    ...
    <div class="card">
      ...
      <h3>Notes</h3>
      <ul>
        <li>This is the <b>you_are_labels_turnwise</b> version: partners are identified as
            "a Human" or "an AI" (no individual names) using "you are talking to" framing,
            and each partner turn is prefixed with "Human:" or "AI:" to reinforce identity at every turn.</li>
        <li>Compare with <code>labels/</code> (system-prompt only) to assess whether
            turn-level identity reinforcement strengthens behavioral effects.</li>
      </ul>
    </div>
    """
...
<head>
<meta charset="UTF-8">
<title>Type-Level Behavioral Analysis -- Exp 1 (you_are_labels_turnwise)</title>
<style>
...
<h1>Human vs AI: Type-Level Behavioral Analysis
    ...
    Exp 1 -- you_are_labels_turnwise -- LLaMA-2-13B-Chat &nbsp;|&nbsp; Generated: {generated}
    </small>
</h1>
{methods_html}
{summary_html}
...
def main():
    ...
    print("=" * 65)
    print("TYPE-LEVEL BEHAVIORAL ANALYSIS -- you_are_labels_turnwise")
    ...
    with open(txt_path, "w") as f:
        f.write(f"TYPE-LEVEL BEHAVIORAL ANALYSIS STATS (you_are_labels_turnwise)\n")
