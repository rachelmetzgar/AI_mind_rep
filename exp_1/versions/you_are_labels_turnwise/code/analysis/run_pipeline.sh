#!/bin/bash
#SBATCH --job-name=ya_ltw_analysis
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=2:00:00
#SBATCH --cpus-per-task=2
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/you_are_labels_turnwise/logs/analysis_pipeline_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/you_are_labels_turnwise/logs/analysis_pipeline_%j.err

# ---------------------------------------------------------------------------
# Automated analysis pipeline for you_are_labels_turnwise experiment.
...
echo "=================================================================="
echo "YOU_ARE_LABELS_TURNWISE ANALYSIS PIPELINE"
echo "Started: $(date)"
echo "Host: $HOSTNAME"
