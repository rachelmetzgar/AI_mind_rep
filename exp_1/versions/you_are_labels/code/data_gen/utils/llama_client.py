...
Provides wrapper for LLaMA models (base and chat).
Chat models use the [INST] template and accept OpenAI-style message lists.

Author: Rachel C. Metzgar
Date: 2025-10-08
Updated: 2025-02-10 — added chat model support for LLaMA-2-Chat
"""
...
class LlamaClient:
    ...
    def _format_messages(self, messages: List[Dict[str, str]]) -> str:
        """Convert OpenAI-style message list to LLaMA-2-Chat prompt format."""
        prompt = ""
        system_msg = None
    ...
    def generate(self, messages: Union[str, List[Dict[str, str]]], temperature: float = None) -> str:
        ...
        Args:
            messages: OpenAI-style message list [{"role": ..., "content": ...}, ...]
                      or a raw string prompt (for backward compatibility)
