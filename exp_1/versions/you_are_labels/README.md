...
**Repo root:** `mind_rep/exp_1/you_are_labels`
**Python:** 3.11+
...
cd /jukebox/graziano/rachel/mind_rep/exp_1/you_are_labels
export PROJECT_ROOT=/jukebox/graziano/rachel/mind_rep/exp_1/you_are_labels/
