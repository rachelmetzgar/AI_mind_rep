#!/bin/bash
#SBATCH --job-name=identity_breakdown_names
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=1:00:00
#SBATCH --cpus-per-task=2
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/names/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/names/logs/identity_breakdown_%j.err

# ---------------------------------------------------------------------------
# Identity breakdown analysis for exp_1/names.
# Compares linguistic behavior across individual partner agents:
#   Sam, Casey (human), ChatGPT, Copilot (AI).
#
...
# === Project paths ===
PROJECT_ROOT="/jukebox/graziano/rachel/mind_rep/exp_1/versions/names"
