#!/bin/bash
#SBATCH --job-name=identity_breakdown_nonsense_codeword
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=1:00:00
#SBATCH --cpus-per-task=2
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/nonsense_codeword/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/nonsense_codeword/logs/identity_breakdown_%j.err

# Type-level behavioral analysis for exp_1/nonsense_codeword.
...
# === Project paths ===
export PROJECT_ROOT="/jukebox/graziano/rachel/mind_rep/exp_1/versions/nonsense_codeword"
