#!/bin/bash
#SBATCH --job-name=gpt4_analysis_pipeline
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=2:00:00
#SBATCH --cpus-per-task=2
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/logs/analysis_pipeline_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/logs/analysis_pipeline_%j.err

# ---------------------------------------------------------------------------
# Automated analysis pipeline for balanced_gpt experiment.
...
echo "=================================================================="
echo "BALANCED_GPT ANALYSIS PIPELINE"
echo "Started: $(date)"
echo "Host: $HOSTNAME"
