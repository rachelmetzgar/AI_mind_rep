#!/bin/bash
#SBATCH --job-name=identity_breakdown_gpt4
#SBATCH --partition=all
#SBATCH --mem=16G
#SBATCH --time=1:00:00
#SBATCH --cpus-per-task=2
#SBATCH --output=/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/logs/identity_breakdown_%j.err

# ---------------------------------------------------------------------------
# Identity breakdown analysis for exp_1/balanced_gpt.
...
# === Project paths ===
export PROJECT_ROOT="/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt"
...
echo "[$(date)] Starting identity_breakdown (balanced_gpt with GPT-4) on host $HOSTNAME"
