#!/bin/bash
# Quick status checker for balanced_gpt experiment
...
echo ""
echo "Data Files:"
DATA_DIR="/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/data/meta-llama-Llama-2-13b-chat-hf/0.8"
if [ -d "$DATA_DIR" ]; then
...
echo ""
echo "Results:"
RESULTS_DIR="/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/results/meta-llama-Llama-2-13b-chat-hf/0.8"
...
LOG_DIR="/jukebox/graziano/rachel/mind_rep/exp_1/versions/balanced_gpt/logs"
if [ -d "$LOG_DIR" ]; then
