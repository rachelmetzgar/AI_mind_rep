# Experiment 1 (Balanced GPT) — Gender-Balanced Names with GPT-4 AI Partner

**Author:** Rachel C. Metzgar, Princeton University
**Repo root:** `mind_rep/exp_1/balanced_gpt`
**Python:** 3.11+

## What Changed from `balanced_names/`

This version uses gender-balanced human names (like `balanced_names/`) but
replaces Copilot with GPT-4 as the second AI partner:

| | `balanced_names/` | `balanced_gpt/` (this version) |
|---|---|---|
...
turns. For `balanced_gpt/`, these artifacts are left as-is because they
...
cd /jukebox/graziano/rachel/mind_rep/exp_1/balanced_gpt
export PROJECT_ROOT=/jukebox/graziano/rachel/mind_rep/exp_1/balanced_gpt/
