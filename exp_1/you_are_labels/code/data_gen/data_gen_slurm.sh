...
#SBATCH --array=0-49
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_labels/logs/llm_data_gen_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_labels/logs/llm_data_gen_%A_%a.err
