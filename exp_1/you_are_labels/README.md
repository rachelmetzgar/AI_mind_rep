# Experiment 1 (You Are Labels) — "You Are Talking To" Framing, Name-Ablated Behavioral Analysis

**Author:** Rachel C. Metzgar, Princeton University
**Repo root:** `ai_mind_rep/exp_1/you_are_labels`
**Python:** 3.11+

## What Changed from `names/`

This is a rerun of Experiment 1 with **generic type labels** and a **"you are
talking to" framing** replacing specific partner names in the system prompt:

| | `names/` (original) | `you_are_labels/` (this version) |
|---|---|---|
...
For the `you_are_labels/` version, **no cleaning is performed**. Rationale:
...
cd /jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_labels
export PROJECT_ROOT=/jukebox/graziano/rachel/ai_mind_rep/exp_1/you_are_labels/
