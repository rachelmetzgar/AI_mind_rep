...
Purpose:
    ...
    (Sam, Casey, ChatGPT, Copilot) in the names exp_1 dataset.

    Compares whether behavior differs across specific individual partners —
    both within type (Sam vs Casey; ChatGPT vs Copilot) and across type
...
Statistics:
    ...
    3. Planned aggregate contrasts (3 per metric, BH-corrected within family):
         a. Human (Sam+Casey mean) vs AI (ChatGPT+Copilot mean)
         b. Sam vs AI aggregate
         c. Casey vs AI aggregate
...
AGENT_ORDER  = ["Sam", "Casey", "ChatGPT", "Copilot"]
HUMAN_AGENTS = ["Sam", "Casey"]
...
def aggregate_contrasts(wide: pd.DataFrame) -> pd.DataFrame:
    ...
    contrasts = [
        ("Human avg vs AI avg",
         human_avg, ai_avg,
         "Mean of (Sam+Casey) vs mean of (ChatGPT+Copilot). "
        ...
        ("Sam vs AI avg",
         data["Sam"], ai_avg,
         "Sam (10 trials/subject) vs AI avg (20 trials/subject). "
         "Test is paired and balanced at N=50; trial count difference noted."),
        ("Casey vs AI avg",
         data["Casey"], ai_avg,
         "Casey (10 trials/subject) vs AI avg (20 trials/subject). "
         "Test is paired and balanced at N=50; trial count difference noted."),
    ]
...
def plot_bar_metric(sub_agent: pd.DataFrame, metric: str,
    ...
    # Legend: type colours
    handles = [
        mpatches.Patch(color=AGENT_COLORS["Sam"],  label="Human"),
...
def build_html(
    ...
    <div class="card">
      ...
      <ul>
        ...
        <li><b>Aggregate contrasts (3 per metric, BH-corrected within this family):</b><br>
            (a) Human mean (Sam+Casey) vs AI mean (ChatGPT+Copilot) — type replication;<br>
            (b) Sam vs AI mean; &nbsp; (c) Casey vs AI mean.</li>
    ...
    <div class="card">
      ...
      <table>
        <thead><tr>
          <th>Metric</th>
          <th>Sam<br><small>M ± SEM</small></th>
          <th>Casey<br><small>M ± SEM</small></th>
    ...
    for m in metrics:
        ...
        if pw.empty:
            continue
        gv = pw[(pw["a"] == "Sam") & (pw["b"] == "Casey")]["sig"].values
        if len(gv) and gv[0]:
    ...
    <div class="card">
      ...
      <h3>Within-human variation (Sam vs Casey)</h3>
      ...
      <ul>
        <li>Significant within-human or within-AI differences would suggest the model
            responds to specific identities, not merely the type label. Name (Sam
            vs Casey) and brand (ChatGPT vs Copilot) are the relevant contrasts.</li>
...
def main():
    ...
    print("=" * 65)
    print("IDENTITY BREAKDOWN ANALYSIS — names")
