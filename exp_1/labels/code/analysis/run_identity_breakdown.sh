...
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_1/labels/logs/identity_breakdown_%j.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_1/labels/logs/identity_breakdown_%j.err
...
# === Project paths ===
PROJECT_ROOT="/jukebox/graziano/rachel/ai_mind_rep/exp_1/labels"
