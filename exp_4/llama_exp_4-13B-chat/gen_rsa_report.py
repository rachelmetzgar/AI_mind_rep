...
def load_rsa(tag):
    path = os.path.join("data", "entity_activations", tag, "rsa_results.json")
...
# ═══════════════════ FIGURE TYPE 3: OVERLAY (existing) ═══════════════════
...
# ═══════════ FIGURE TYPE 4: 4-PANEL RDM OVERVIEW (existing) ═══════════
...
def generate_html():
    ...
    if rsa_ws is None and rsa_ns is None:
        print("ERROR: No rsa_results.json found. "
              "Run 1b_rsa_by_dimension.py first.")
        return
