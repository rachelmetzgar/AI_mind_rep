...
def run_extraction(model_obj, tokenizer):
    ...
    ddir = data_dir("expanded_mental_concepts", "internals", "rsa")
    rdir = results_dir("expanded_mental_concepts", "internals", "rsa")
    ...
    behavioral_rdm = None
    behavior_data_dir = data_dir("expanded_mental_concepts", "behavior", "pca")
