...
Usage:
    python expanded_mental_concepts/internals/rsa/matched_rsa.py --model llama2_13b_base
    python expanded_mental_concepts/internals/rsa/matched_rsa.py --model llama2_13b_chat --both
...
def generate_for_model(model_key):
    ...
    beh_ddir = data_dir("expanded_mental_concepts", "behavior", "pca")
    all_rsa = {}
