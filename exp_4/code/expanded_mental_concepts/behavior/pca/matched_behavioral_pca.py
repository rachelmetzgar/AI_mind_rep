...
Usage:
    python expanded_mental_concepts/behavior/pca/matched_behavioral_pca.py --model llama2_13b_base
    python expanded_mental_concepts/behavior/pca/matched_behavioral_pca.py --model llama2_13b_chat --both
