...
Output (all with pairwise_ prefix):
    ...
    results/{model}/expanded_mental_concepts/behavior/pca/
        pairwise_results_summary.md

Usage:
    python expanded_mental_concepts/behavior/pca/behavioral_pca.py --model llama2_13b_chat
    python expanded_mental_concepts/behavior/pca/behavioral_pca.py --model llama2_13b_base
    python expanded_mental_concepts/behavior/pca/behavioral_pca.py --model llama2_13b_chat --both
