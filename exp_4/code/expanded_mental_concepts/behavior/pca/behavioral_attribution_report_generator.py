...
Usage:
    python expanded_mental_concepts/behavior/pca/behavioral_attribution_report_generator.py --model llama2_13b_base
    python expanded_mental_concepts/behavior/pca/behavioral_attribution_report_generator.py --model llama2_13b_chat
    python expanded_mental_concepts/behavior/pca/behavioral_attribution_report_generator.py --model llama2_13b_chat --both
...
from expanded_mental_concepts.concepts import CONCEPT_NAMES, CONCEPT_DIMENSIONS
...
SECTIONS = [
    ...
    {"id": "effect-sizes", "label": "4. Effect Sizes"},
    {"id": "direction-validation", "label": "5. Direction Validation"},
    {"id": "per-character", "label": "6. Per-Character Breakdown"},
    {"id": "heatmap", "label": "7. Concept x Character Heatmap"},
]
...
""")
    ...
    # Section 3: Human advantage per concept
    fig_num += 1
    html.append(f"""
<h2 id="human-advantage">3. Human Advantage per Concept</h2>
...
""")
    ...
    fig_num += 1
    html.append(f"""
<h2 id="effect-sizes">4. Effect Sizes</h2>
...
""")
    ...
    html.append(f"""
<h2 id="direction-validation">5. Direction Validation</h2>
...
""")
    ...
    # Section 6: Per-character breakdown
    fig_num += 1
    html.append(f"""
<h2 id="per-character">6. Per-Character Breakdown</h2>
...
<table><tr><th>Character</th><th>N pairs</th><th>Mean Score</th><th>Std</th></tr>""")
    ...
    fig_num += 1
    html.append("""
<h2 id="heatmap">7. Concept x Character Heatmap</h2>
