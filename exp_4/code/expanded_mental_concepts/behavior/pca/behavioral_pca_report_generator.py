...
Usage:
    python expanded_mental_concepts/behavior/pca/behavioral_pca_report_generator.py --model llama2_13b_chat
    python expanded_mental_concepts/behavior/pca/behavioral_pca_report_generator.py --model llama2_13b_base
    python expanded_mental_concepts/behavior/pca/behavioral_pca_report_generator.py --model llama2_13b_chat --dataset reduced_dataset
...
SECTIONS = [
    ...
    {"id": "consistency", "label": "4. Order Consistency"},
    {"id": "scree", "label": "5. Scree Plot"},
    {"id": "loadings", "label": "6. Factor Loadings"},
    {"id": "scatter", "label": "7. Character Positions"},
    {"id": "group-means", "label": "8. Per-Concept Group Means"},
    {"id": "anomalies", "label": "9. Anomalies"},
]
...
""")
    ...
    if consistency_stats.get("n_pairs_both", 0) > 0:
        html_parts.append(f"""
<h2 id="consistency">4. Order Consistency</h2>
<div class="stat">
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="loadings">6. Factor Loadings (Varimax-Rotated)</h2>
...
""")
    ...
    if "scatter" in figures:
        fig_num += 1
        html_parts.append(f"""
<h2 id="scatter">7. Character Positions in Factor Space</h2>
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="group-means">8. Per-Concept Group Means</h2>
...
""")
    ...
    if anomalies:
        html_parts.append("""
<h2 id="anomalies">9. Anomalies</h2>
