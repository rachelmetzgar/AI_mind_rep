...
def fig1_scree_plot():
    ...
    save_fig(fig, FIG_DIR, "fig1_scree_plot")
...
def fig2_loading_comparison():
    ...
    save_fig(fig, FIG_DIR, "fig2_loading_comparison")
...
def fig3_entity_scatter():
    ...
    save_fig(fig, FIG_DIR, "fig3_entity_scatter_pairwise")
...
def fig4_mind_space():
    ...
    save_fig(fig, FIG_DIR, "fig4_mind_space_comparison")
...
def fig5_rating_heatmap():
    ...
    fig.tight_layout()
    save_fig(fig, FIG_DIR, "fig5_rating_heatmap")
...
def fig6_individual_scatter():
    ...
    save_fig(fig, FIG_DIR, "fig6_individual_entity_scatter")
...
def fig7_rsa_layerwise():
    ...
    for idx, cond in enumerate(["without_self", "with_self"]):
        ...
        # New format has {combined: [...], experience: [...], agency: [...]}
        # Use combined variant for fig7
        ...
        ax.annotate(f"peak: rho={rhos_clean[peak_idx]:.3f}\nlayer {layers[peak_idx]}",
                    (layers[peak_idx], rhos_clean[peak_idx]),
    ...
    save_fig(fig, FIG_DIR, "fig7_rsa_layerwise")
...
def fig8_correlation_summary():
    ...
    fig.tight_layout()
    save_fig(fig, FIG_DIR, "fig8_correlation_summary")
...
def fig9_pairwise_heatmap():
    ...
    fig.tight_layout()
    save_fig(fig, FIG_DIR, "fig9_pairwise_heatmap")
...
def fig10_rdm_comparison():
    ...
    # Support new format (human_rdm_combined) with fallback to old (human_rdm)
    if "human_rdm_combined" in rdm_data:
        human_rdm = rdm_data["human_rdm_combined"]
    else:
        human_rdm = rdm_data["human_rdm"]
    ...
    save_fig(fig, FIG_DIR, "fig10_rdm_comparison")
