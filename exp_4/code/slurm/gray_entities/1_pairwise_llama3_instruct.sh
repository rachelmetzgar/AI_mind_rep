#!/bin/bash
#SBATCH --job-name=exp4_pairwise_l3inst
#SBATCH --output=/mnt/cup/labs/graziano/rachel/mind_rep/exp_4/logs/gray_replication/pairwise_llama3_instruct_%j.out
...
python gray_entities/behavioral/1_pairwise_replication.py --model llama3_8b_instruct --include_self
