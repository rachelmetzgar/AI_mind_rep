...
Reads:  data_dir("gray_replication", "behavior", condition)/{method}_pca_results.npz
Writes: data_dir("gray_replication", "behavior", condition)/{method}_human_comparisons.json
