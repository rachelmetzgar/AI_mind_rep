...
Reads from:  data_dir("gray_replication", "behavior", condition)/
Writes to:   results_dir("gray_replication", "behavior", condition)/
...
def generate_report(model_key, method, condition):
    ...
    """
    set_model(model_key)
    ddir = str(data_dir("gray_replication", "behavior", condition))
    rdir = str(results_dir("gray_replication", "behavior", condition))
