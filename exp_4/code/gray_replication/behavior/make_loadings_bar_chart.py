...
Reads: data_dir("gray_replication", "behavior", condition)/pairwise_pca_results.npz
Writes: results_dir("gray_replication", "behavior", condition)/figures/loadings_sorted_by_value.png + .svg
...
def main():
    ...
    ddir = data_dir("gray_replication", "behavior", args.condition)
    rdir = results_dir("gray_replication", "behavior", args.condition)
