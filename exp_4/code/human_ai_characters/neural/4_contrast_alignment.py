...
extract_activations = _il.import_module(
    "human_ai_characters.neural.1_extract_character_activations"
).extract_activations
...
def run(model_obj, tokenizer):
    ...
    char_data_dir = data_dir("human_ai_characters", "neural/names_only", "rsa_pca")
    ...
    # ── Save ──
    out_dir = data_dir("human_ai_characters", "neural/names_only/alignment", "contrast")
    rdir = results_dir("human_ai_characters", "neural/names_only/alignment", "contrast")
