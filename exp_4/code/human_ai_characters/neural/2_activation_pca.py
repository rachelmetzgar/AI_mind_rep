...
Output:
    ...
    results/{model}/expanded_mental_concepts/internals/pca/
        internal_pca_summary.md

Usage:
    python expanded_mental_concepts/internals/pca/activation_pca.py --model llama2_13b_chat
    python expanded_mental_concepts/internals/pca/activation_pca.py --model llama2_13b_base
...
def run_internal_pca(model_key):
    ...
    rsa_ddir = data_dir("human_ai_characters", "neural/names_only", "rsa_pca")
    # Output: PCA results
