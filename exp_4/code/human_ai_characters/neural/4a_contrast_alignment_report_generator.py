...
Usage:
    python expanded_mental_concepts/internals/contrast_alignment/contrast_alignment_report_generator.py --model llama2_13b_chat
...
def generate_report(model_key):
    ...
    ddir = data_dir("human_ai_characters", "neural/names_only/alignment", "contrast")
