...
Uses existing character activations from expanded_mental_concepts/internals/rsa/data/
...
Reads from:
    data_dir("expanded_mental_concepts", "internals", "rsa")/
...
SECTIONS = [
    ...
    {"id": "rsa-profile", "label": "3. RSA Layer Profile"},
    {"id": "results-table", "label": "4. Per-Layer Results"},
]
...
def generate_report(model_key, dataset="full_dataset"):
    ...
    act_ddir = data_dir("expanded_mental_concepts", "internals", "rsa")
    ...
    gray_ddir = data_dir("human_ai_characters", "behavioral/gray_capacities")
...
""")
    ...
    fig_num += 1
    html.append(f'<h2 id="rsa-profile">3. RSA Layer Profile</h2>\n')
...
""")
    ...
    # Layer table
    html.append("""
<h2 id="results-table">4. Per-Layer Results</h2>
<table>
...
""")
    ...
    out_dir = str(results_dir("human_ai_characters", "behavioral/gray_capacities"))
