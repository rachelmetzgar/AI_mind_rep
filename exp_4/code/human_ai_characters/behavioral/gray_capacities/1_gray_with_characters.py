...
characters from entities (instead of Gray's original 13 entities).
...
Design:
    - 30 characters (15 AI + 15 human) from entities/characters.py
...
Output:
    ...
    results_dir("human_ai_characters", "behavioral/gray_capacities")/
