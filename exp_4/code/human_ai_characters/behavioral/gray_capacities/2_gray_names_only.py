...
Output:
    data_dir("human_ai_characters", "behavioral/gray_capacities", "names_only")/
    ...
    results_dir("human_ai_characters", "behavioral/gray_capacities", "names_only")/
...
def run_names_only(args):
    ...
    # Output dirs
    ddir = data_dir("human_ai_characters", "behavioral/gray_capacities", CONDITION)
    rdir = results_dir("human_ai_characters", "behavioral/gray_capacities", CONDITION)
