...
Usage:
    python human_ai_characters/behavior/pca/matched_behavioral_pca.py --model llama2_13b_base
    python human_ai_characters/behavior/pca/matched_behavioral_pca.py --model llama2_13b_chat --both
...
def generate_for_model(model_key):
    ...
    from entities.characters import ALL_CHARACTERS
