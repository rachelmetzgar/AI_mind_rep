...
Usage:
    python concept_geometry/rsa/standalone_alignment_report_generator.py --model llama2_13b_chat
...
def generate_report(model_key):
    ...
    ddir = data_dir("concept_geometry/rsa", "standalone_alignment")
    rdir = results_phase_dir("concept_geometry/rsa", "standalone_alignment")
