...
Output:
    ...
    results/{model}/concept_geometry/rsa/activation/
        internals_results_summary.md

Usage:
    python concept_geometry/rsa/activation_rsa.py --model llama2_13b_chat
    python concept_geometry/rsa/activation_rsa.py --model llama2_13b_base
    python concept_geometry/rsa/activation_rsa.py --model llama2_13b_chat --both
...
def run_extraction(model_obj, tokenizer):
    ...
    behavioral_rdm = None
    behavior_data_dir = data_dir("concept_geometry/pca", "behavioral")
