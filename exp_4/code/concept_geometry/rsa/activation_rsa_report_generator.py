...
Writes to:
    results/{model}/concept_geometry/rsa/activation/{dataset}/
        activation_rsa_report.html

Usage:
    python concept_geometry/rsa/activation_rsa_report_generator.py --model llama2_13b_chat
    python concept_geometry/rsa/activation_rsa_report_generator.py --model llama2_13b_base
    python concept_geometry/rsa/activation_rsa_report_generator.py --model llama2_13b_chat --dataset reduced_dataset
...
SECTIONS = [
    ...
    {"id": "rsa-by-layer", "label": "3. RSA by Layer"},
    {"id": "rdm-heatmaps", "label": "4. RDM Heatmaps at Peak Layer"},
    {"id": "within-between", "label": "5. Within vs Between Group Distances"},
    {"id": "character-prompts", "label": "6. Character Prompts"},
]
...
def generate_report(model_key, dataset="full_dataset"):
    ...
    ddir = data_dir("concept_geometry/rsa", "activation")
    rdir = results_phase_dir("concept_geometry/rsa", "activation")
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="rsa-by-layer">3. RSA by Layer</h2>
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="rdm-heatmaps">4. RDM Heatmaps at Peak Layer ({peak_layer})</h2>
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="within-between">5. Within-Group vs. Between-Group Distances</h2>
...
""")
    ...
    # Character prompts
    html_parts.append("""
<h2 id="character-prompts">6. Character Prompts</h2>
