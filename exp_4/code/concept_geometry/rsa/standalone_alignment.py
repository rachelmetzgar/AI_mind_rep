...
Output → results/{model}/concept_geometry/rsa/standalone_alignment/data/:
...
Usage:
    python concept_geometry/rsa/standalone_alignment.py --model llama2_13b_chat
...
STANDALONE_DIR = Path(__file__).resolve().parent.parent.parent.parent.parent / "exp_3" / "concepts" / "standalone"
...
def run(model_obj, tokenizer):
    ...
    # ── Save ──
    out_dir = data_dir("concept_geometry/rsa", "standalone_alignment")
