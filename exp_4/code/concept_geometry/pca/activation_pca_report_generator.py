...
Writes to:
    results/{model}/concept_geometry/pca/activation/{dataset}/
        activation_pca_report.html

Usage:
    python concept_geometry/pca/activation_pca_report_generator.py --model llama2_13b_chat
...
SECTIONS = [
    ...
    {"id": "layer-profile", "label": "3. Layer Profile"},
    {"id": "scatter", "label": "4. Character Positions at Peak Layer"},
    {"id": "significance", "label": "5. Statistical Significance"},
]
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="layer-profile">3. Layer Profile</h2>
...
""")
    ...
    if "scatter_peak" in figures:
        fig_num += 1
        html_parts.append(f"""
<h2 id="scatter">4. Character Positions at Peak Layer (L{peak_sil_layer})</h2>
...
""")
    ...
    fig_num += 1
    html_parts.append(f"""
<h2 id="significance">5. Statistical Significance Across Layers</h2>
