...
Output (all with pairwise_ prefix):
    ...
    results/{model}/concept_geometry/pca/behavioral/
        pairwise_results_summary.md

Usage:
    python concept_geometry/pca/behavioral_pca.py --model llama2_13b_chat
    python concept_geometry/pca/behavioral_pca.py --model llama2_13b_base
    python concept_geometry/pca/behavioral_pca.py --model llama2_13b_chat --both
...
from concept_geometry.concepts import CONCEPT_DIMENSIONS, CONCEPT_KEYS
