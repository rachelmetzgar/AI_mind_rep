...
Usage:
    python concept_geometry/pca/matched_behavioral_pca_report_generator.py --model llama2_13b_base
    python concept_geometry/pca/matched_behavioral_pca_report_generator.py --model llama2_13b_chat --both
...
SECTIONS = [
    ...
    {"id": "cross-subset", "label": "2. Cross-Subset Comparison"},
    {"id": "subset-details", "label": "3. Per-Subset Details"},
]
...
<h2 id="cross-subset">2. Cross-Subset Comparison</h2>
<table>
...
""")
    ...
    for subset in SUBSETS:
        ...
        if first_subset:
            html.append(f'\n<h2 id="subset-details">3. {label}</h2>\n')
            first_subset = False
        else:
            html.append(f'\n<h2 id="subset-{subset}">3. {label}</h2>\n')
