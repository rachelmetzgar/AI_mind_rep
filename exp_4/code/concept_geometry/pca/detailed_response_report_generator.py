...
Usage:
    python concept_geometry/pca/detailed_response_report_generator.py --model llama2_13b_base
    python concept_geometry/pca/detailed_response_report_generator.py --model llama2_13b_chat --both
    python concept_geometry/pca/detailed_response_report_generator.py --model llama2_13b_chat --dataset reduced_dataset
...
SECTIONS = [
    ...
    {"id": "per-character", "label": "3. Per-Character Scores"},
    {"id": "concept-group", "label": "4. Concept x Group Means"},
    {"id": "heatmap", "label": "5. Concept x Character Heatmap"},
    {"id": "distribution", "label": "6. Rating Distribution"},
    {"id": "position-bias", "label": "7. Position Bias"},
]
...
""")
    ...
    fig_num = 1
    html.append(f"""
<h2 id="human-advantage">2. Human Advantage per Concept (Cross-Type Pairs)</h2>
...
""")
    ...
    html.append(f"""
<h2 id="per-character">3. Per-Character Relative Scores</h2>
...
""")
    ...
    fig_num += 1
    html.append(f"""
<h2 id="concept-group">4. Concept x Group Means</h2>
...
""")
    ...
    fig_num += 1
    html.append(f"""
<h2 id="heatmap">5. Full Concept x Character Heatmap</h2>
...
""")
    ...
    fig_num += 1
    html.append(f"""
<h2 id="distribution">6. Rating Distribution</h2>
...
""")
    ...
    fig_num += 1
    html.append(f"""
<h2 id="position-bias">7. Position Bias</h2>
