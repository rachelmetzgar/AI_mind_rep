...
Usage:
    python concept_geometry/pca/matched_activation_pca.py --model llama2_13b_base
    python concept_geometry/pca/matched_activation_pca.py --model llama2_13b_chat --both
...
from config import (
    ...
    data_dir, results_phase_dir, N_LAYERS,
)
...
def generate_for_model(model_key):
    ...
    for subset in ["directional", "human", "ai", "all"]:
        ...
        if os.path.exists(pca_path):
            ...
            # RSA at each layer
            rdm_ddir = data_dir("concept_geometry/rsa", "activation")
    ...
    # Save
    out_ddir = data_dir("concept_geometry/pca", "activation")
    save_kwargs = {
