...
Usage:
    python 1a_rsa_report.py --model chat
    python 1a_rsa_report.py --model base
...
from src.utils import nice_entity
...
"""
    ...
    html += (f'\n<p class="small" style="margin-top:2rem;text-align:center">'
             f'Generated by <code>1a_rsa_report.py --model {model_key}</code></p>\n'
             '</body>\n</html>')
