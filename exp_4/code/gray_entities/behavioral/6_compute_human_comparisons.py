...
Reads:  data_dir("gray_entities", "behavioral", condition)/{method}_pca_results.npz
Writes: data_dir("gray_entities", "behavioral", condition)/{method}_human_comparisons.json
