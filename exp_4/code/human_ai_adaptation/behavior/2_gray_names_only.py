...
Output:
    data_dir("human_ai_adaptation", "behavior", "names_only")/
    ...
    results_dir("human_ai_adaptation", "behavior", "names_only")/
...
def run_names_only(args):
    ...
    # Output dirs
    ddir = data_dir("human_ai_adaptation", "behavior", CONDITION)
    rdir = results_dir("human_ai_adaptation", "behavior", CONDITION)
