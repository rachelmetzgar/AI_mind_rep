...
Reads: results/{model}/behavior/with_self/data/pairwise_pca_results.npz
Writes: results/{model}/behavior/with_self/figures/loadings_sorted_by_value.png + .svg
...
def main():
    ...
    ddir = data_dir("behavior", args.condition)
    rdir = results_phase_dir("behavior", args.condition)
