...
SECTIONS = [
    ...
    {"id": "human-advantage", "label": "2. Human Advantage per Capacity"},
    {"id": "per-character", "label": "3. Per-Character Scores"},
    {"id": "heatmap", "label": "4. Capacity x Character Heatmap"},
    {"id": "exp-vs-ag", "label": "5. Experience vs Agency"},
]
...
""")
    ...
    # ── Human advantage ──
    html.append(f'<h2 id="human-advantage">2. Human Advantage per Capacity</h2>\n')
...
""")
    ...
    # ── Per-character ──
    html.append(f'<h2 id="per-character">3. Per-Character Scores</h2>\n')
    ...
    # ── Heatmap ──
    html.append(f'<h2 id="heatmap">4. Capacity x Character Heatmap</h2>\n')
    html.append(html_figure(
        figures['heatmap'],
    ...
    html.append(f'<h2 id="exp-vs-ag">5. Experience vs Agency Comparison</h2>\n')
    html.append(html_figure(
        figures['exp_vs_ag'],
