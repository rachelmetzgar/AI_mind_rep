...
SECTIONS = [
    ...
    {"id": "scree", "label": "2. Scree Plot"},
    {"id": "scatter", "label": "3. Character Positions"},
    {"id": "loadings", "label": "4. Capacity Loadings"},
    {"id": "alignment", "label": "5. Categorical Alignment"},
    {"id": "scores", "label": "6. Character Factor Scores"},
    {"id": "consistency", "label": "7. Order Consistency"},
]
...
""")
    ...
    # ── Scree ──
    html.append(f'<h2 id="scree">2. Scree Plot</h2>\n')
    ...
    if "scatter" in figures:
        html.append(f'<h2 id="scatter">3. Character Positions in Factor Space</h2>\n')
        html.append(html_figure(
            figures['scatter'],
    ...
    # ── Loadings ──
    html.append(f'<h2 id="loadings">4. Capacity Loadings (Varimax-Rotated)</h2>\n')
...
<table><tr><th>Capacity</th><th>Gray Factor</th>""")
    ...
    if cat_analysis.get("factors"):
        html.append(f"""
<h2 id="alignment">5. Categorical Alignment (AI vs Human)</h2>
...
""")
    ...
    html.append(f"""
<h2 id="scores">6. Character Factor Scores</h2>
<table><tr><th>Character</th><th>Type</th>""")
    ...
    if consistency_stats.get("n_pairs_both", 0) > 0:
        html.append(f"""
<h2 id="consistency">7. Order Consistency</h2>
<div class="stat">
