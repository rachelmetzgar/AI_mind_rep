...
Usage:
    python code/rsa/7_variant_rsa.py --metric cosine --variant original
    python code/rsa/7_variant_rsa.py --metric correlation --variant you
    python code/rsa/7_variant_rsa.py --metric cosine --variant you

SLURM:
    sbatch code/rsa/slurm/7_variant_cosine.sh
    sbatch code/rsa/slurm/7_variant_corr_you.sh
    sbatch code/rsa/slurm/7_variant_cosine_you.sh
