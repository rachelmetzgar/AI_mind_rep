...
Usage:
    python code/rsa/3_partial_rsa.py --model llama2_13b_chat
    python code/rsa/3_partial_rsa.py --model llama2_13b_chat --analysis primary
    python code/rsa/3_partial_rsa.py --model llama2_13b_chat --analysis secondary

SLURM:
    sbatch code/rsa/slurm/3_partial_rsa.sh
