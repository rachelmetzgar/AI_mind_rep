...
Usage:
    python code/9_attribution_probes.py --model llama2_13b_chat

SLURM:
    sbatch code/slurm/9_attribution_probes.sh
    ...
    for probe_name, defn in PROBE_DEFS.items():
        ...
        for pos in range(N_POSITIONS):
            ...
            for layer in range(nl):
                ...
                w, b = train_full_probe(X, labels_sub)
