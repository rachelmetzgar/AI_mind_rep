...
ACT_ROOT = str(config.PATHS.concept_activations_contrasts)
ALIGN_ROOT = str(config.RESULTS.alignment)
PROBE_DATA_ROOT = str(config.PATHS.concept_probes)
OUT_ROOT = str(config.RESULTS.root / "probes" / "alignment")
SUMMARIES_DIR = str(config.RESULTS.root / "probes" / "alignment" / "summaries")
METHODS_DIR = str(config.RESULTS.root / "probes" / "alignment" / "methods")
