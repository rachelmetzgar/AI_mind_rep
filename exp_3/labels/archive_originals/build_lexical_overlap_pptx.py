...
# ── paths ─────────────────────────────────────────────────────────────────
LEX_FIG = Path(str(config.RESULTS.lexical / "lexical_overlap_investigation" / "figures"))
CONTRAST_FIG = Path(str(config.RESULTS.root / "probes" / "alignment" / "figures"))
STANDALONE_FIG = Path(str(config.RESULTS.root / "probes" / "standalone_alignment" / "figures"))
LEX_CSV = Path(str(config.RESULTS.lexical / "lexical_distinctiveness.csv"))
OUT_PATH = Path(str(config.RESULTS.lexical / "lexical_overlap_investigation" / "LEXICAL_OVERLAP_REPORT.pptx"))
