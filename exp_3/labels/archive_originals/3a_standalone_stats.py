...
ACT_ROOT = str(config.PATHS.concept_activations_standalone)
OUT_ROOT = str(config.RESULTS.root / "probes" / "standalone_alignment")
SUMMARIES_DIR = str(config.RESULTS.root / "probes" / "standalone_alignment" / "summaries")
METHODS_DIR = str(config.RESULTS.root / "probes" / "standalone_alignment" / "methods")
