...
#SBATCH --array=1-19
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_3/llama_exp_3-13B-chat/logs/elicit/standalone_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_3/llama_exp_3-13B-chat/logs/elicit/standalone_%A_%a.err
# -------------------------------------------------------------
...
python code/pipeline/1_elicit_concept_vectors.py \
    --mode standalone \
    --dim_id ${DIM_ID} \
