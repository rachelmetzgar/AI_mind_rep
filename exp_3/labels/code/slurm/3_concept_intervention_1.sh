...
#SBATCH --array=0-19
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_3/llama_exp_3-13B-chat/logs/concept_V1/%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_3/llama_exp_3-13B-chat/logs/concept_V1/%A_%a.err
# ---------------------------------------------------------------------------
...
#
# Submit:
#   sbatch 3_concept_intervention_V1.sh
#   sbatch --array=7,3,4,11 3_concept_intervention_V1.sh   # subset
# ---------------------------------------------------------------------------
...
python code/pipeline/3_concept_intervention.py \
    --mode V1 \
    --dim_id "$DIM_ID" \
    --strengths 1 2 4
