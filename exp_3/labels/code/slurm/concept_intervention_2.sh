...
#SBATCH --array=0-49
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_3-13B-chat_mind/logs/concept_v2_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_3-13B-chat_mind/logs/concept_v2_%A_%a.err
# -------------------------------------------------------------
...
python code/pipeline/3_concept_intervention.py --mode v2 --vector_source probe --subject_idx $IDX
