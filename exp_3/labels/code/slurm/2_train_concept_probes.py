...
#SBATCH --array=0-19
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_3/llama_exp_3-13B-chat/logs/train_concept_probes/%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_3/llama_exp_3-13B-chat/logs/train_concept_probes/%A_%a.err
# -------------------------------------------------------------
...
python code/pipeline/2_train_concept_probes.py \
    --dim_id ${DIM_ID}
