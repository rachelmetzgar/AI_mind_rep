...
ALIGNMENT_ROOT = str(config.RESULTS.alignment)
OUTPUT_ROOT = str(config.RESULTS.alignment)

# Directory mapping: raw and residual live under contrasts/
ANALYSIS_DIR_MAP = {
    "raw": str(config.RESULTS.alignment_contrasts_raw),
    "residual": str(config.RESULTS.alignment_contrasts_residual),
    "standalone": str(config.RESULTS.alignment_standalone),
}
