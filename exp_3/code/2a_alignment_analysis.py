#!/usr/bin/env python3
"""
Experiment 3, Phase 2a: Concept-Probe Alignment Analysis
...
Three analyses, organized under two output folders:
    ...
    contrasts/raw/       Raw cosine alignment between human-AI contrast vectors
                         ...
                         Uses data from: results/{model}/concept_activations/contrasts/
    ...
    standalone/          Cosine alignment between standalone mean activation
                         ...
                         Uses data from: results/{model}/concept_activations/standalone/
...
Usage:
    python 2a_alignment_analysis.py --version labels --analysis raw
    python 2a_alignment_analysis.py --version balanced_names --analysis residual
    python 2a_alignment_analysis.py --version labels --analysis standalone
    python 2a_alignment_analysis.py --version labels --analysis all
...
# Version-independent paths (always available)
