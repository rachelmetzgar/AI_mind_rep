#!/usr/bin/env python3
"""
Experiment 3, Phase 2d: System Prompt ↔ Concept Alignment Analysis

Computes alignment between system prompt representations (from 2c) and
concept dimension representations (from Phase 1), answering:
...
Usage:
    python 2d_sysprompt_alignment.py --analysis all
    python 2d_sysprompt_alignment.py --analysis contrast
    python 2d_sysprompt_alignment.py --analysis standalone
    python 2d_sysprompt_alignment.py --analysis bare
