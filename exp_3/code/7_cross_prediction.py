...
Inputs:
    Exp 3 concept probes:     results/{model}/concept_probes/concept_probe_layer_*.pth
    Exp 3 concept activations: results/{model}/concept_activations/concept_activations.npz
    Exp 3 concept vectors:     results/{model}/concept_activations/concept_vector_per_layer.npz
...
from utils.dataset import TextDataset, llama_v2_prompt
...
CONCEPT_PROBE_DIR = str(config.RESULTS.concept_probes_data)
CONCEPT_ACT_PATH = str(config.RESULTS.concept_activations / "concept_activations.npz")
CONCEPT_VEC_PATH = str(config.RESULTS.concept_activations / "concept_vector_per_layer.npz")
