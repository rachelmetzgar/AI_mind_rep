#!/usr/bin/env python3
"""
Experiment 3, Phase 2c: System Prompt Partner Identity Elicitation
...
1_elicit_concept_vectors.py so that 2a_alignment_analysis.py can
...
Usage:
    python 2c_elicit_sysprompt_vectors.py           # all conditions
    python 2c_elicit_sysprompt_vectors.py --only contrasts
    python 2c_elicit_sysprompt_vectors.py --only standalone
...
OUTPUT_ROOT = str(config.RESULTS.concept_activations)
...
def main():
    ...
    print(f"\n{'=' * 60}")
    print(f"Phase 2c complete. Re-run 2a_alignment_analysis.py to include new dims.")
    print(f"{'=' * 60}")
