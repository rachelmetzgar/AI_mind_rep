...
directory layout: results/versions/{version}/concept_steering/v1/{dim}/{strategy}/
...
# Utils are under exp_1/versions/{version}/code/analysis/
# Word lists are identical across versions; use 'labels' as canonical source.
EXP1_UTILS_DIR = os.path.join(
    PROJECT_ROOT, "exp_1", "versions", "labels", "code", "analysis",
)
...
def main():
    ...
    v1_root = os.path.join(
        PROJECT_ROOT, "exp_3", "results", "versions", args.version,
        "concept_steering", "v1",
    )
