...
# ── paths ──────────────────────────────────────────────────────────────────
CONTRASTS = Path(str(config.RESULTS.concept_activations_contrasts))
DIM_TABLE = Path(str(config.RESULTS.root / "probes" / "alignment" / "summaries" / "dimension_table.csv"))
...
# ── also save CSV ─────────────────────────────────────────────────────────
out_csv = Path(str(config.RESULTS.lexical / "lexical_distinctiveness.csv"))
