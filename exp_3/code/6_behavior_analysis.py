...
EXP1_CODE_DIR = str(config.PATHS.exp1_utils)
...
RESULT_ROOT_V1 = str(config.RESULTS.interventions_v1)
RESULT_ROOT_V2 = str(config.RESULTS.interventions_v2)
