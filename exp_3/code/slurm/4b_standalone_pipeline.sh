...
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_3/logs/standalone_pipeline/%j.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_3/logs/standalone_pipeline/%j.err
# -------------------------------------------------------------
