...
#SBATCH --array=1-19
#SBATCH --output=/jukebox/graziano/rachel/ai_mind_rep/exp_3/logs/elicit/standalone_%A_%a.out
#SBATCH --error=/jukebox/graziano/rachel/ai_mind_rep/exp_3/logs/elicit/standalone_%A_%a.err
# -------------------------------------------------------------
