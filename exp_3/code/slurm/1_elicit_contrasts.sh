...
#SBATCH --array=16-17
#SBATCH --output=/mnt/cup/labs/graziano/rachel/mind_rep/exp_3/logs/elicit/contrasts_%A_%a.out
#SBATCH --error=/mnt/cup/labs/graziano/rachel/mind_rep/exp_3/logs/elicit/contrasts_%A_%a.err
# -------------------------------------------------------------
