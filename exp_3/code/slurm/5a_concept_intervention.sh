...
#SBATCH --array=0-19
#SBATCH --output=/mnt/cup/graziano/rachel/mind_rep/exp_3/logs/concept_V1/%A_%a.out
#SBATCH --error=/mnt/cup/graziano/rachel/mind_rep/exp_3/logs/concept_V1/%A_%a.err
# ---------------------------------------------------------------------------
...
python code/5_concept_intervention.py \
    --mode V1 \
    --dim_id "$DIM_ID" \
    --strengths 1 2 4
