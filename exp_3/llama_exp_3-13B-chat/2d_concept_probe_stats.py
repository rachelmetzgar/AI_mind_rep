...
DIM_LABELS = {
    ...
    14: "Biological", 15: "Shapes", 16: "Mind (holistic)",
...
def main():
    ...
    with open(methods_path, "w") as f:
        ...
        f.write("We test whether concept directions (mean human - mean AI activations "
                ...
                "probe** (surface-level partner detection) and the **reading probe** "
                "(internal model of conversational partner).\n\n")
