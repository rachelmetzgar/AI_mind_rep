...
PROBE_ROOT = "data/concept_probes"
ALIGN_ROOT = "data/alignment"
OUTPUT_CSV = os.path.join(PROBE_ROOT, "summary_all_dimensions.csv")
STATS_DIR  = os.path.join(PROBE_ROOT, "summary_stats")
HIDDEN_DIM = 5120
N_BOOTSTRAP = 10000
