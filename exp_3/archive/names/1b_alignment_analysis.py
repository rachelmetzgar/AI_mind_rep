...
CONTRAST_ACT_DIR = "data/concept_activations/contrasts"
STANDALONE_ACT_DIR = "data/concept_activations/standalone"
OUTPUT_ROOT = "data/alignment_results"

# Output subdirectories — raw and residual live under contrasts/
CONTRASTS_OUTPUT_DIR = os.path.join(OUTPUT_ROOT, "contrasts")
RAW_OUTPUT_DIR = os.path.join(CONTRASTS_OUTPUT_DIR, "raw")
RESIDUAL_OUTPUT_DIR = os.path.join(CONTRASTS_OUTPUT_DIR, "residual")
STANDALONE_OUTPUT_DIR = os.path.join(OUTPUT_ROOT, "standalone")

# Probe directories (from Experiment 2b)
EXP2B_PROBE_ROOT = (
    "/jukebox/graziano/rachel/ai_mind_rep/exp_2b/llama_exp_2b-13B-chat/"
    "data/probe_checkpoints"
)
READING_PROBE_DIR = os.path.join(EXP2B_PROBE_ROOT, "reading_probe")
CONTROL_PROBE_DIR = os.path.join(EXP2B_PROBE_ROOT, "control_probe")

INPUT_DIM = 5120  # LLaMA-2-13B
