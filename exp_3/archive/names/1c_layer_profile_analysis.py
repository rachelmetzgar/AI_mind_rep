#!/usr/bin/env python3
"""
Experiment 3, Phase 1c: Per-Layer Alignment Profile Analysis

Reads alignment results from 1b_alignment_analysis.py and produces
...
Usage:
    python 1c_layer_profile_analysis.py --analysis raw
    python 1c_layer_profile_analysis.py --analysis residual
    python 1c_layer_profile_analysis.py --analysis standalone
    python 1c_layer_profile_analysis.py --analysis all
...
ALIGNMENT_ROOT = "data/alignment_results"
OUTPUT_ROOT = "data/alignment_results"

# Directory mapping: raw and residual live under contrasts/
ANALYSIS_DIR_MAP = {
    "raw": os.path.join(ALIGNMENT_ROOT, "contrasts", "raw"),
    "residual": os.path.join(ALIGNMENT_ROOT, "contrasts", "residual"),
    "standalone": os.path.join(ALIGNMENT_ROOT, "standalone"),
}
