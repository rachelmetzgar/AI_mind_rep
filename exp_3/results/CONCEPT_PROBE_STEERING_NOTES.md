...
1. Run existing script: `exp_3/code/pipeline/3_train_concept_probes.py` (array job, one per dim)
2. Check per-layer accuracy vs mean vector alignment
3. Run cross-prediction: `exp_3/code/pipeline/7_cross_prediction.py` (needs probes + GPU)
