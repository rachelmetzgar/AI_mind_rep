...
|---------|---|---|---|
| Partner Identity | 0.602 | 2.568 | Balanced names with GPT-4 replacing 'AI' partner — explicit identity cues |
| Control | 0.194 | 0.294 | Nonsense codewords replacing identity labels — no meaningful identity cues |
