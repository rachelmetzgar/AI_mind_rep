...
|---------|---|---|---|
| Partner Identity | 0.322 | 3.131 | Balanced names with GPT-4 replacing 'AI' partner — explicit identity cues |
| Control | 0.459 | 5.170 | Nonsense codewords replacing identity labels — no meaningful identity cues |
