...
|---------|---|---|---|
| Partner Identity | 0.359 | 5.202 | Balanced names with GPT-4 replacing 'AI' partner — explicit identity cues |
| Control | 0.306 | 0.985 | Nonsense codewords replacing identity labels — no meaningful identity cues |
