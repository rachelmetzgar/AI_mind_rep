...
|---------|---|---|---|
| Partner Identity | 0.372 | 7.340 | Balanced names with GPT-4 replacing 'AI' partner — explicit identity cues |
| Control | 0.589 | 1.270 | Nonsense codewords replacing identity labels — no meaningful identity cues |
