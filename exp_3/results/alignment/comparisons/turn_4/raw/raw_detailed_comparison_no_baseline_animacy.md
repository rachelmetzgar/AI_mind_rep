...
|---------|---|---|---|
| Partner Identity | 0.396 | 4.786 | Balanced names with GPT-4 replacing 'AI' partner — explicit identity cues |
| Control | 0.205 | 0.345 | Nonsense codewords replacing identity labels — no meaningful identity cues |
